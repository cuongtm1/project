				...
				<div class="news-list">
					<div class="row">
						...
						<div class="news-list-block">
							<div class="col-4">
								<a href="tin-tuc/<?php echo e($value->slug); ?>.html"><img class="news-img" src="public/image/<?php echo e($value->image); ?>" alt="" width="223" height="149"></a>
							</div>
							<div class="col-8 news-text">
								<h4 class="news-list-title"><a href="tin-tuc/<?php echo e($value->slug); ?>.html"><?php echo e($value->title); ?></a></h4>
								<i class="far fa-calendar-alt"></i>
								<span><?php echo e(date_format($value->created_at,'d/m/Y')); ?></span>
