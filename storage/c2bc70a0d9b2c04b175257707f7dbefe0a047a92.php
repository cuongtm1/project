					...
					<table class="table table-hover table-bordered" id="sampleTable">
						...
						<tbody>
							...
							<tr>
								...
								<td><a class="btn btn-success" href="admin/activate/pending/delconfirm/<?php echo e($value->getChildrenJoinActivate->id); ?>">Hủy tham gia</a>
...
<?php echo $__env->make('backend.master.masterlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\project1\views/backend/activate/join.blade.php ENDPATH**/ ?>